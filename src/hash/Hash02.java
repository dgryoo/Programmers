...
public class Hash02 {
    ...
    public static void main(String[] args) {
        ...
        if(solution(test01) == false) System.out.println("test01 ok!!");
        if(solution(test02) == true) System.out.println("test02 ok!!");
        if(solution(test03) == false) System.out.println("test03 ok!!");
